...
3. **Documenter les contraintes** techniques découvertes3. **Garantir la cohérence** entre les différents systèmes

---4. **Arbitrer les décisions** architecturales
...
### Core Mechanic- **Resolution**: 720x1280 (portrait), stretch mode "keep_height"- **Target**: Android/iOS

Le joueur influence un combat automatique via une **zone tripartite**:

- **HEAL** (bleu, gauche) - Soigne le héros, pression +20%

- **ATTACK** (rouge, droite) - Attaque bonus, pression +25%- **DODGE** (violet, centre) - Boost d'esquive, pression +15%

...
| **Role** | Core Systems & Game Logic || **Name** | Backend Developer Agent ||-------|-------|
...
3. **Entity Behaviors** - Fast, Tank, Regen, Toxic behaviors5. **Save System** - Persistence, currency, progression4. **Pressure System** - Jauges, overload, timers3. **State Machine** - Combat states et transitions
...
├── entities/│ └── pressure_gauge.gd│ ├── combat_state_machine.gd│ ├── combat_manager.gd

│ ├── base_entity.gd

│ ├── entity_stats.gd

│ └── behaviors/│ ├── base_enemy.gd│ ├── base_hero.gd

│ ├── enemy_behavior.gd

│ ├── regen_behavior.gd│ ├── tank_behavior.gd│ ├── fast_behavior.gd
